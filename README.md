...
| `Cockpit SPA`       | The single web page: fleet, inbox, world, live agent output, decision log, inject + kill. External references (issues, PRs, branches) render as clickable links, using URLs the provider supplies.                                                                                                                                                    |
