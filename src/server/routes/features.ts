...
export function register(app: FastifyInstance, { system, hub }: RouteContext): void {
  ...
  app.get(
    ...
    checked({}, async ({ reply }) => {
      ...
      return featureBoardPayload(system);
    }),
  );
...
function featureBoardPayload(system: RouteContext['system']): FeatureBoardPayload {
  ...
  return {
    ...
    refUrls: boardRefUrls(connector, board),
  } satisfies FeatureBoardPayload;
}

function boardRefUrls(
  connector: RouteContext['system']['connector'],
  board: ReturnType<typeof buildFeatureBoard>,
