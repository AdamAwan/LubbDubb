...
import type { SpendBurnDesk } from '../insights/spendBurnDesk.js';
...
import type { PrBodyEditDesk } from '../pr/prBodyEditDesk.js';
...
const ENTRIES = [
  ...phase('reconcile', [
    ...
    { id: 'prBodyEdits', readWorld: true, run: (d, at) => d.prBodyEdits?.run(at.world) },
