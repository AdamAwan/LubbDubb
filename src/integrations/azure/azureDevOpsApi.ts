...
export interface AzPull {
  ...
  /**
   * `creationDate` — when the pull request was opened.
   *
   ...
   * it costs no request. Empty where Azure did not report one, which the intake
   * reads as "cannot say" rather than as old.
   */
  openedAt: string;
}
