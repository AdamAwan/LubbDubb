...
export interface RuleConditions {
  ...
  /** `validation.checkSets` — whether a delivered goal's check set is authored and proposed at all. */
  checkSets: boolean;
