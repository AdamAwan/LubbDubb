 ...
 *
 * Rule `manual-job` needs it to dispatch, and the work graph's fold needs it to recognise
 ...
 * all — the same discriminator rule `manual-job` already applies when it chooses between a
