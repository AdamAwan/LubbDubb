 ...
 */
export function StampDesk({ view, actions }: FloorProps): JSX.Element {
  return (
 ...
 */
export function Slip({ escalation, view, actions }: FloorProps & { escalation: Escalation }): JSX.Element {
  return (
    <EscalationCard
 ...
 */
export function FaultLog({ view, actions }: FloorProps): JSX.Element {
 ...
 */
export function BlueprintDesk({ view, actions }: FloorProps): JSX.Element {
  return (
    <>
      <LaunchPanel
 ...
 */
export function FindingsDesk({ view, actions }: FloorProps): JSX.Element {
  const { state, now } = view;
