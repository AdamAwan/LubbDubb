 ...
 * the decision log's own badges read. Reading it here rather than adding a field
 * is what keeps the log and the badges agreeing about who did what.
 *
 ...
 * `decisionAttribution` is shared with the badge helper so neither has to
 * re-decide what a pre-split row means.
 *
