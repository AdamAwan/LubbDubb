    ...
    insights: {
      ...
      acts: [
        ...
        act(
          ...
          'A person described a pull request themselves rather than taking the agent’s draft',
          3,
        ),
      ],
...
export const demoApi = {
  ...
  decideObstacleTicket: (_id: string, _approved: boolean) => Promise.reject(new Error(DEMO_NO_BOARD)),
