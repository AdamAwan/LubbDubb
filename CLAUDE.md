...
repo's one documentation rule; [`docs/README.md`](docs/README.md) indexes the twenty-nine documents and
...
[`docs/README.md`](docs/README.md) is the index: twenty-nine specs, one per subsystem, numbered by the
