...
`work_item_filings`, `work_item_ignores`, `pr_watch_seeds`, `pr_work_item_links`, `profile_overrides` and `issue_bug_filings` were all introduced as new tables and therefore needed no
