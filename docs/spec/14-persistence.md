...
| `usage_events`              | Timestamped per-report cost **deltas** (not cumulative) for the fleet's **agents**, so rolling windows are a `SUM`. `agent_id` is `NOT NULL` and is the join `buildCiHealth` prices a pull request's CI through — which is why a local run's delta goes in its own table rather than here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | —                                                                                                                                                                                                                                                                                                                                                |
