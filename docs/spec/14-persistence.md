...
| `goal_criteria_alignments`  | **Not yet built.** The alignment check's reading of one criteria version against the ticket's own criteria: the verdict, each point's tag, and whether the operator pressed on past a `conflicting` one. [08](08-planning.md#the-alignment-check)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `UNIQUE (origin_ref, version)`                                                                                                                                                                                                                                                                                                                   |
