...
**Where the [intake sitting](08-planning.md#the-intake-sitting-stands-in-front-of-the-planner) is
built, the stamp is written when the sitting closes, before the planner is dispatched** — so
`criteriaStanding` needs no change: a version written in the sitting precedes the stamp and the plan
alike, and the labels keep their names although _reveal_ now means _the sitting ended_. Not yet built;
today the stamp is written at the plan's reveal.
