...
| `plans.ts`            | `plans`, `plan_parts`, `plan_revisions`, `plan_amendments`                      |
...
| `plan_parts`                           | `plans.ts`          | `touches`, `rationale`, `acceptance`, `acceptance_met`, `size`, `expected_kind`, `outcome_kind`, `outcome_ref`, `outcome_summary`, `blocked_reason`, `blocked_by`, `profile`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
`tasks(status)`, `jobs(status)`, `job_attachments(target_ref)`, `job_schedules(enabled, next_run_at)`, `plans(origin_ref)`, `plan_parts(plan_id)`, `plan_caveat_answers(plan_id)`, `validation_checks(origin_ref)`,
