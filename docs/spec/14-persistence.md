...
| `issue_assays`                         | `issueVerdicts.ts` | `proposed_profile`, `profile_answered_at` — the profile an assayer proposed for the work, and when the operator answered it; `proposed_parent`, `parent_settled_at`, `proposed_area_path`, `area_path_settled_at` — where on the backlog the assayer said the goal belongs, and when the operator answered each. Null on every row from before they existed, which is the right reading for all four: no proposal, nothing asked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
