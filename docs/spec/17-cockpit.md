...
| `layout`                             | the Tickets tab's layout: `card` for the board of state columns; `table` is the absent value. Its own key rather than `view`, which the Insights page owns; an old `view=card` link still reads as the board                                                                                                                                                                                                                                       |
