...
of 0 — is refused at load, naming the key. **The mock runtime reports no usage**, so nothing there
can ever trip the watch. → [18](18-observability.md#the-burn-watch)
