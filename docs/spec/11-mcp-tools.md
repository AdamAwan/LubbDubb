...
| `pr_describe`               | Write the description of a pull request the operator handed back to an agent (`manualDescriptions` on). The body runs `prBodyRefusal` — the rules `open_pr`'s `body` runs with the key off — and is recorded on the part's handoff, which `PrDescriptionDesk` pushes above the footer. Refused to any caller whose origin is not `issue:<n>:describe:<pr>`. → [07](07-pull-requests.md#handing-it-back-to-the-agent)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
