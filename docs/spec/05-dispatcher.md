...
The six PR-concern rules and `pr-merge-ready` run as **one pass** over the open PRs rather than seven,
...
10. **Handed-over validation checks** (`validate-check`), last of everything. Validation's standing
