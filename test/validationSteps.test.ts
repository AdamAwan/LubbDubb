...
test('a check dispatched across a boundary is told to stop at it and hand back with what it has', () => {
  ...
  const check: ValidationCheck = {
    ...
    covers: [],
    steps: [
      { kind: 'browser', do: 'Fill the basket', area: null, when: 'inline', actor: 'fleet', why: null },
      {
        kind: 'manual',
      ...
      { kind: 'state', do: 'Read the order row back', area: null, when: 'inline', actor: 'fleet', why: null },
    ],
    fleetCandidate: false,
    candidateWhy: null,
    actor: 'fleet',
